{
  ...
  Originally by D.Maslov. Rewritten by dsp2003
}
unit AE_Misc_MD5;
...
var a,b,c,d: UINT4; x: array[0..15] of UINT4;
begin
 a := State[0];
 b := State[1];
 c := State[2];
...
var bits: array[0..7] of Byte; index,padLen: longword;
begin
...
function MD5Stream(const Stream: TStream): TMD5Digest;
var Context: TMD5Context; Buffer: array[0..$FFF] of byte; Size,ReadBytes,TotalBytes,SavePos: int64;
begin
 MD5Init(Context);
 Size := Stream.Size;
