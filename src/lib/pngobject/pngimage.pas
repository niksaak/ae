...
{/////////////////////////////////////////////////////////////}
{     WARNING! This is NOT the original library version!      }
{/////////////////////////////////////////////////////////////}

{Since several modifications and bugfixes were implemented by }
{dsp2003 for AE - VN Tools, you are using this version at your}
{own risk.                                                    }
      ...
      begin
        ...
        begin
          ...
          if (AlphaSource[i2] <> 0) then
           { WinKiller Studio: commented out due to a BUG! }
