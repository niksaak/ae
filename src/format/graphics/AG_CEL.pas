...
type
 ...
 TCEL_IMAG = packed record
  ...
  OffsetNextEntry : longword;
  Number1         : longword; // пор€дковый номер изображени€, начина€ с нул€
...
{ ‘ормат CEL использует довольно мудрЄный способ представлени€ данных. }
function Import_CEL;
var i,j : integer;
    RFI : TRFI;
...
/////////////////////////////////////////////////////////////////////////////////////////
  RFI_Init(IMAGQty); // ”станавливаем кол-во слотов в буфере дл€ изображений
/////////////////////////////////////////////////////////////////////////////////////////
  ...
  for i := 0 to IMAGQty-1 do begin
   ...
   TempoStream.Size := 0; // обнул€ем временный поток

   case CEL_IMAG[i].CompFlag of
   0: TempoStream.CopyFrom(InputStream,CEL_IMAG[i].ImageLength);
   1: begin
       FillChar(CEL_LZ,SizeOf(CEL_LZ),0); // обнул€ем LZ-буфер, на вс€кий случай ;)
